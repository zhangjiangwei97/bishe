...
<%@page import="com.zjw.service.ComplainService"%>
<%@page import="com.zjw.bean.Complain"%>
<%
...
<html>
 ...
 <style type="text/css">  
    ...
    <tr align="center"> 
        ...
        <th width="300" class="td2">投诉内容</th>       
        <th width="300" class="td2">投诉时间</th>   
    </tr>  
    </thead>  
    <tbody id="adminTbody">  
    
    <%
           ComplainService dao=new ComplainService();
           List<Complain> list =dao.readFirstTitle();    
           for(Complain tl:list)
           {%>
          
          <tr>
              <td class="td2" height="33" width="150"><%=tl.getName() %></td>	              
              <td class="td2"><%=tl.getTalk() %></td>
              <td class="td2"><%=tl.getSys_time() %></td>
