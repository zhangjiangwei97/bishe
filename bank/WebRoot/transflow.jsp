...
<%@page import="com.zjw.service.TransService"%>
<%@page import="com.zjw.bean.TraflowBean"%>
<%
...
<html>
 ...
 <link rel="stylesheet" href="banksys/css/fenye/fenye.css"> 
    ...
    <tr align="center"> 
        ...
        <th width="300" class="td2">柜台存款</th>
        <th width="300" class="td2">柜台取款</th>      
        <th width="300" class="td2">操作时间</th>    
    </tr>  
    </thead>  
    <tbody id="adminTbody">  
    
    <%
           TransService dao=new TransService();
           List<TraflowBean> list =dao.readFirstTitle();    
           for(TraflowBean tl:list)
           {%>
          
          <tr>
              <td class="td2" height="33" width="150"><%=tl.getNum() %></td>	              
              <td class="td2"><%=tl.getName() %></td>
              <td class="td2"><%=tl.getCmoney() %></td>
              <td class="td2"><%=tl.getQmoney() %></td>
              <td class="td2"><%=tl.getOperatime() %></td>
          </tr>
