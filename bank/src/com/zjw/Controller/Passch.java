...
public class Passch extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String name = (String)request.getSession().getAttribute("login_user");
		System.out.print("passch"+name);
		String passch=request.getParameter("passch");
		System.out.print("passch"+passch);
		UserBean us = new UserBean(name,passch,"","","");
